...
const ProductsCard = (product) => {
    ...
    return (
        ...
        <p className="text-lg font-mono">{product.product_name}</p>
        ...
        <Link to={`/products/${_id}`}><button className="bg-yellow-500 hover:bg-yellow-400 text-gray-800 font-bold py-2 px-4 rounded-full shadow-md hover:shadow-lg hover:animate-bounce transition-all">
          Recommend
        </button></Link>
      </div>
    );
